...
Func = args:FuncArgs _ block:BlockStatement { return { statement: "function", args: args, body: block }; }
FuncArgs = "(" _ ")" / "(" _ head:FuncArg _ tail:("," _ FuncArg _)* _ ")" { return [head].concat(tail.map(function(t) { return t[2]; })); }
...
VarDecl = type:Type _ name:Id _ ("=" _ VarValue)? _ ("," _ Id _ ("=" _ VarValue)?)* { return { statement: "var", location: location(), type: type, name: name, decl: text() }; }
